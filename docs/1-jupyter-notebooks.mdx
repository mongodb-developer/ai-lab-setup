...
<Screenshot url="https://play.instruqt.com" src="img/screenshots/1-jupyter-notebooks/1-run-cell.png" alt="Run a cell" />

When a cell is running, you will see a loading spinner in the bottom left corner of the cell. 

<Screenshot url="https://play.instruqt.com" src="img/screenshots/1-jupyter-notebooks/2-running-cell.png" alt="A running cell" />
...
<Screenshot url="https://play.instruqt.com" src="img/screenshots/1-jupyter-notebooks/3-successful-cell.png" alt="Successful cell run" />
...
<Screenshot url="https://play.instruqt.com" src="img/screenshots/1-jupyter-notebooks/4-error-in-cell.png" alt="Erroneous cell run" />
...
<Screenshot url="https://play.instruqt.com" src="img/screenshots/1-jupyter-notebooks/5-interrupt-cell.png" alt="Interrupt cell run" />
